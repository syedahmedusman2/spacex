...
export type LaunchMissinInfoQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type LaunchMissinInfoQuery = (
  { __typename?: 'Query' }
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
...
export const LaunchMissinInfoDocument = gql`
...
/**
 * __useLaunchMissinInfoQuery__
 *
 * To run a query within a React component, call `useLaunchMissinInfoQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaunchMissinInfoQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaunchMissinInfoQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useLaunchMissinInfoQuery(baseOptions?: Apollo.QueryHookOptions<LaunchMissinInfoQuery, LaunchMissinInfoQueryVariables>) {
        return Apollo.useQuery<LaunchMissinInfoQuery, LaunchMissinInfoQueryVariables>(LaunchMissinInfoDocument, baseOptions);
      }
export function useLaunchMissinInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchMissinInfoQuery, LaunchMissinInfoQueryVariables>) {
          return Apollo.useLazyQuery<LaunchMissinInfoQuery, LaunchMissinInfoQueryVariables>(LaunchMissinInfoDocument, baseOptions);
        }
export type LaunchMissinInfoQueryHookResult = ReturnType<typeof useLaunchMissinInfoQuery>;
export type LaunchMissinInfoLazyQueryHookResult = ReturnType<typeof useLaunchMissinInfoLazyQuery>;
export type LaunchMissinInfoQueryResult = Apollo.QueryResult<LaunchMissinInfoQuery, LaunchMissinInfoQueryVariables>;